...
(function () {
    ...
    var RTB = {
        version: "rtmap.lbspoisdk.1.0.0.js",
        ...
        lbsurl: "http://lbsapitest2.rtmap.com:8080/rtmap_lbs_api/v1/rtmap/lbs_locateinfo",// lbs定位接口 "http://lbsapi.rtmap.com/rtmap_lbs_api/v1/rtmap/lbs_locateinfo"
        param: {                         // 提交给lbs的参数
            "user_id": "",
            // "user_id_desc": window.navigator.userAgent, 
            "user_id_desc": "摇一摇openid",
            "brand": "",
            "imei": "",
            "key": "0KwOHEy7BQ",
            "latitude": "",
                        ...
                        _this.onScanSearch(jsonData, function (argv){
                            if (argv.beacons) {
                                ...
                                if (_this.status == "ready" &&
                                    ((_this.beacons.length >= _this.scanMax) ||
    ...
    RTB.getAttrInit = function () {
        var _this = this;
        var acceptAttr = ["namespace", "scanTimeout", "loadTimeout", "postTimeout", "scanMax", "scanMin", "rssiMax", "rssiMin"];
        var attr = {};
